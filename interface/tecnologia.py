...
class TelaTecnologia:
    ...
    def _secao_operacional(self):
        ...
        pesquisa = tk.Entry(controles, bg=CORES["input"], fg=CORES["text"], insertbackground=COR_TI, relief="flat")
        ...
        self.tabela.pack(side="left", fill="both", expand=True, padx=1, pady=1)
        adicionar_divisorias_treeview(self.tabela, cor=CORES["border"])
