...
class TelaCompras:
    ...
    def _secao_operacional(self):
        ...
        pesquisa = tk.Entry(filtros, bg=CORES["input"], fg=CORES["text"], insertbackground=COR_COMPRAS, relief="flat")
        pesquisa.insert(0, "Pesquisar nesta seção...")
        ...
        pesquisa.bind("<KeyRelease>", lambda _evento: self._preencher_tabela(pesquisa.get()))
    ...
    def _preencher_tabela(self, termo=""):
        ...
        if termo == "pesquisar nesta seção...":
            termo = ""
