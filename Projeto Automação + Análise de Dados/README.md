...
> **Release atual: V9.3 — Release Engineering + Zero Defects.** Para distribuir o código-fonte, não compacte a pasta manualmente; use `python scripts/empacotar_fonte_limpa.py`. O release oficial usa Python 3.14 e os arquivos `requirements*.lock.txt`.
