...
def executar_capturas(
    ...
    *,
    ...
    # gerados por este script evita misturar PNGs obsoletos com a rodada atual.
    for antigo in destino.glob("[0-9][0-9][0-9]_*.png"):
        antigo.unlink(missing_ok=True)
    for nome_resumo in ("FOLHA_CONTATO.png", "RELATORIO_VISUAL.md", "MANIFESTO_VISUAL.json"):
        (destino / nome_resumo).unlink(missing_ok=True)
