...
python -m pytest -q tests/test_v9_integrada.py tests/test_v9_1_autoridade_central.py tests/test_auditoria_regressoes.py tests/test_v9_4_release_engineering.py
